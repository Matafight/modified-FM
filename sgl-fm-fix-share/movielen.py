...
if __name__=='__main__':
    ...
    best_reg = [0.01,0.01]
    fm = pylibfm.FM(num_factors = 10,num_iter=200,verbose = True,task="regression",initial_learning_rate=0.001,learning_rate_schedule="optimal",dataname=train_data_name,reg_1 = best_reg[0], reg_2 = best_reg[1])
